...
public static class Utils
{
    ...
    /// </summary>
    public static Vector2 BilinearInterpolate(Vector2 frac, Vector2 a, Vector2 b, Vector2 c, Vector2 d)
    {
        /*  
         *   c-------d
         *   |       |
        ...
        // x axis
        Vector2 aToB = Vector2.Lerp(a, b, frac.x);
        Vector2 cToD = Vector2.Lerp(c, d, frac.x);

        return Vector2.Lerp(aToB, cToD, frac.y);
    }

    /// <summary>
    /// Interpolate values between a square of points.
    /// </summary>
    public static Vector3 BilinearInterpolate(Vector2 frac, Vector3 a, Vector3 b, Vector3 c, Vector3 d)
    {
        /*  
         *   c-------d
         *   |       |
        ...
        // y axis
        return Vector3.Lerp(aToB, cToD, frac.y);
    }
    ...
    /// <summary>
    /// Use Acos to get the clockwise angle of the given 2d direction in degrees.
    /// </summary>
